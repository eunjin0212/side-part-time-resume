...
const Home = () => {
  const COVER_LETTER = [
    ...
    {
      title: 'T.G.I Fridays',
      part: 'Server & Kitchen Assistant (Seasonal)',
      range: '2019-05 ~ 2019-06',
      details: [
        'During my seasonal role at T.G.I. Fridays in Goyang, I supported both the dining floor and kitchen, serving food and preparing simple menu items.',
        'I also managed orders and payments through the POS system while keeping the restaurant clean and organized.',
        'This experience strengthened my ability to multitask and work as part of a team in a busy dining environment.',
      ],
      imgs: ['/assets/tgi.jpg', '/assets/tgi2.jpg'],
    },
    {
      title: 'Clubs',
      part: 'Server',
  ...
  return (
    <>
      <Script
        src={`https://www.googletagmanager.com/gtag/js?id=G-N9X4J7F272`}
      ...
      <main>
        ...
        <Section>
          ...
          <p>Known for staying calm under pressure, providing attentive service, and maintaining a positive
            attitude.</p>
          <p>Recognized for strong responsibility, quick problem-solving, and a team-first mindset.</p>
        </Section>
        ...
        <Section className="py-20 text-center text-8xl max-md:text-5xl max-sm:text-4xl">
          ...
          <div className='flex justify-center gap-10 mt-10'>
            <a href="tel:+821072006011" className={[contactClass, 'duration-300'].join(' ')}>
        ...
        <em>Visa expire on 2027.04.27</em>
      </main>
    </>
  )
}
